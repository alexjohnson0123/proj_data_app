...
interface SelectGroupProps extends ComponentProps<typeof SelectPrimitive.Group> {
  className?: string
}
...
interface SelectLabelProps extends ComponentProps<typeof SelectPrimitive.GroupLabel> {
  className?: string
}
...
interface SelectSeparatorProps extends ComponentProps<typeof SelectPrimitive.Separator> {
  className?: string
}
...
interface SelectScrollButtonProps extends ComponentProps<typeof SelectPrimitive.ScrollUpArrow> {
  className?: string
}
