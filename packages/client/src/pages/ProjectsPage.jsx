...
export default function ProjectsPage() {
  ...
  const [filters, setFilters] = useState({ q: '', client: '', sphere: '', projectType: '', attr: {} })
  ...
  function handleAttr(label, value) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3">
        <Select value={filters.client || ALL} onValueChange={v => handleFilter('client', v)}>
        ...
        <Select value={filters.sphere || ALL} onValueChange={v => handleFilter('sphere', v)}>
          <SelectTrigger className="w-44">
        ...
        <Select value={filters.projectType || ALL} onValueChange={v => handleFilter('projectType', v)}>
